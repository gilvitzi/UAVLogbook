...
public class ExportDBExcelTask extends ExportTableToExcelTask{
	public ExportDBExcelTask(Activity activity, String fileName, String filePath) {
		super(activity, fileName, filePath, LogbookReportQuery.getAllSessions());
	}
