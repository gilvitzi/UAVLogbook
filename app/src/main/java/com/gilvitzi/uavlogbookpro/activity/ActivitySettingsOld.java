...
//
//public class ActivitySettingsOld extends AnalyticsActivity {
//    private static final String LOG_TAG = "ActivitySettingsOld";
...
//
//        hoursFractionFormatSwitch = null; //(Switch) findViewById(R.id.F);
